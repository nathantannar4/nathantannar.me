...
extension Resume {
    ...
    static func generate() -> Resume {
        let education: [Education] = [
            Education(school: "Simon Fraser University", degree: "Bachelors of Applied Science", concentration: "Computer Engineering", date: "Sept 2014 - April 2019", awards: ["Dean's Honor Roll 2017/2018"], url: "http://www.sfu.ca/engineering/current-students/undergraduate-students/programs-and-requirements/computer-engineering.html"),
        ...
        let jobs: [Job] = [
            Job(title: "iOS Engineering Intern", company: "FORM Athletica (Startup)", highlights: ["Developed a companion app for an augmented reality fitness wearable that used BLE", "Shaped pixel perfect user interfaces by working alongside UI/UX designers", "Optimized the networking layer by 40% by improving the raw data decoding and adding multi-threaded processing", "Leveraged knowledge of RxSwift alongside MVVM and dependency-injection design"], date: "SEPT 2018 - DEC 2018", url: "https://www.formathletica.com"),
            Job(title: "System Support Engineer Intern", company: "SAP Canada", highlights: ["Developed an internal iOS app that leveraged SAP’s mobile development platforms to present a list and map of all discounts available to SAP employees", "Solved critical issues that effected the downtime of customers systems", "Debugged errors during upgrades, installations, source code implementation and database migrations", "Published internal and external knowledge articles that would solve common problems"], date: "MAY 2016 - APRIL 2017", url: "https://www.sap.com/canada/about.html"),
            Job(title: "Programming Mentor", company: "Udacity", highlights: ["Participated as a mentor to hundreds of students online who were learning software development for the first time", "Reviewed student’s projects and submitted feedback to help them improve", "Promoted correct coding conventions and best practices", "Wrote blogs and other online tutorials"], date: "NOV 2017 – AUG 2018", url: "https://www.sap.com/canada/about.html"),
        ...
        let skills: [Skill] = [
            Skill(name: "Languages", description: "Swift, Objective-C, C/C++, Java, JavaScript, HTML/CSS, Git, SQL, MATLAB, VHDL"),
            Skill(name: "Software", description: "Git, XCode, CocoaPods, Carthage, NGINX, MySQL, Fastlane"),
            Skill(name: "Frameworks", description: "RxSwift, Moya/Alamofire, IGListKit, MapKit, CoreAnimation, ARKit, Swinject")
        ]
        let projects: [Project] = [
            Project(name: "MessageKit", caption: "A UI library for messaging applications", highlights: ["2600+ Stars on GitHub"], language: "Swift 4.2", version: "2.0.0", category: "Framework", description: "MessageKit is a UI framework built in Swift to replace JSQMessagesViewController. It has quickly gained traction as a common trending repository on Github. I spearheaded the development of a robust and versatile InputAccessoryView that the library uses as its message input view.", url: "https://github.com/MessageKit/MessageKit", imageUrl: "https://github.com/MessageKit/MessageKit/blob/master/Assets/mklogo.png?raw=true"),
            Project(name: "InputBar\nAccessoryView", caption: "A reactive InputAccessoryView", highlights: ["380+ Stars on GitHub"], language: "Swift 4.2", version: "4.0.3", category: "Framework", description: "With ease you can create a reactive input bar similar to those found in Facebook Messenger, Slack, iMessage and many more. InputAccessoryView also makes it easy to add predictive autocomplete functionality.", url: "https://github.com/nathantannar4/InputBarAccessoryView", imageUrl: "https://raw.githubusercontent.com/nathantannar4/InputBarAccessoryView/master/Screenshots/Preview.gif"),
            ...
            Project(name: "HalalMe", caption: "Freelance Contract", highlights: [], language: "Swift 4", version: "1.0.1", category: "Freelance", description: "Working with a startup of local SFU students I aided by developing their iOS client for HalalMe - an aggregated source of Halal restaurants in Vancouver", url: "http://halalme.xyz", imageUrl: "http://halalme.xyz/img/cover1.jpg"),
            Project(name: "TypingIndicator", caption: "A replica of iMessage's typing indicator bubble", highlights: ["130+ Stars on GitHub", "Featured by The iOS Times"], language: "Swift 4.1", version: "0.1.0", category: "Concept", description: "A working prototype of an iMessage like typing indicator that quickly gained traction being featured by multiple tech blogs and articles", url: "https://github.com/nathantannar4/TypingIndicator", imageUrl: "https://raw.githubusercontent.com/nathantannar4/TypingIndicator/master/banner.png"),
