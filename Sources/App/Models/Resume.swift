...
extension Resume {
    ...
    static func generate() -> Resume {
        ...
        let jobs: [Job] = [
            Job(title: "iOS Engineering Intern", company: "FORM Athletica", highlights: ["Contributed to developing the beta for a next generation augmented reality fitness wearable", "Re-Engineered the networking layer of the application, increasing performance by 40%", "Developed a robust caching layer for offline use that featured automatic object expiration"], date: "SEPT 2018 - DEC 2018", url: "https://www.formathletica.com"),
        ...
        let skills: [Skill] = [
            ...
            Skill(name: "Technologies", description: "RxSwift, RESTful, Node.js, Google Cloud Platform, Apple APNS")
        ]
        let projects: [Project] = [
            Project(name: "MessageKit", caption: "A UI library for messaging applications", highlights: ["2400+ Stars on GitHub"], language: "Swift 4.2", version: "2.0.0", category: "Framework", description: "MessageKit is a UI framework built in Swift to replace JSQMessagesViewController. It has quickly gained traction as a common trending repository on Github. I am one of the projects maintainers and core developers.", url: "https://github.com/MessageKit/MessageKit", imageUrl: "https://github.com/MessageKit/MessageKit/blob/master/Assets/mklogo.png?raw=true"),
